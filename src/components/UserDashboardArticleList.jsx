...
const UserDashboardArticleList = ( { articleProps, handlePageClick, handleDelete } ) => {
    const { articlesFound, username, screenSize, pageNum, articles, accumCount, totalCount, loggedUser, userStr } = articleProps;
    const disablePrevButton = pageNum === 1 || articles.length === 0;
